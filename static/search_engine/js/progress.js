class CeleryProgressBar {
    ...
    constructor(progressUrl, options) {
        ...
        this.progressDataTableElement = options.progressDataTableElement || document.getElementById(table);
    ...
    onProgressDefault(progressBarElement, progressDataTableElement, progressBarMessageElement, progress) {
    ...
    onData(data) {
        let done = false;
        if (data.progress) {
            this.onProgress(this.progressBarElement, this.progressDataTableElement, this.progressBarMessageElement, data.progress);
        }
